...
import veganSupplementImg from '../../assets/images/Vegan Energy Supplement.png';
import naturalBarImg from '../../assets/images/Natural Energy Bar.png';
import proteinPowderImg from '../../assets/images/Protein Powder Blend.png';
...
const Products = () => {
  ...
  //     reviewCount: 210
  //   },
  //   { id: 1, name: "Protein Cookies", price: 6, image: proteinCookiesImg, category: "snacks", description: "Delicious protein-packed cookies made with natural ingredients." },
  //   { id: 2, name: "Chickpea Protein Snack", price: 25, image: chickpeaSnackImg, category: "snacks", description: "Crunchy roasted chickpeas with a perfect blend of spices." },
  //   { id: 3, name: "Fruity Energy Bar", price: 59, image: fruityBarImg, category: "bars", description: "Energy bar packed with dried fruits and nuts for a natural boost." },
  //   { id: 4, name: "Nut & Seed Bar", price: 46, image: nutSeedBarImg, category: "bars", description: "A satisfying blend of nuts and seeds for sustained energy." },
  //   { id: 5, name: "Vegan Energy Supplement", price: 119, image: veganSupplementImg, category: "supplements", description: "Plant-based energy supplement with no artificial additives." },
  //   { id: 6, name: "Natural Energy Bar", price: 56, image: naturalBarImg, category: "bars", description: "Simple ingredients for clean energy without the crash." },
  //   { id: 7, name: "Protein Powder Blend", price: 149, image: proteinPowderImg, category: "supplements", description: "Premium protein powder with complete amino acid profile." }
  // ];
